      ...
      {loading ? (
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="flex flex-col items-center gap-3">
            <h1 className="text-2xl md:text-5xl xl:text-7xl text-white text-center px-3 xl:px-0">Welcome, {userData?.name}</h1>
            <p className="text-muted text-xl capitalize text-center">

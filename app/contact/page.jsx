            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-10">
              <div className="text">
                ...
                <p className="text-sm text-accent">
                  ...
                  <a href="tel:01092971381" className="cursor-pointer">01092971381</a>
                </p>
              </div>
              <div className="text">
                <Mail />
                ...
                <p className="text-sm text-accent">
                  <a href="mailto:dotphonestore@gmail.com" className="me-2">dotphonestore@gmail.com</a>
                </p>
              </div>
              <div className="text">
                <Instagram />
                ...
                <p className="text-sm text-accent">
                  <a href="https://www.instagram.com/dot.phonestore?igsh=eHJjaXd3cWJqd2F6" target="_blank" className="me-2">dotphone Store</a>
                </p>
              </div>
              <div className="text">
                <Watch />
